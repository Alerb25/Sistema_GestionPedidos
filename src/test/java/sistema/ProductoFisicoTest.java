 ...
 class ProductoFisicoTest {
    ...
    @Test
     void testCosteEnvioEspana() {
        ProductoFisico prod = new ProductoFisico("Libro", 20.0, 0.0);
    ...
    @Test
     void testCosteEnvioZonasIntermedias() {
        ProductoFisico prod = new ProductoFisico("Silla", 80.0, 0.0);
    ...
    @Test
     void testCosteEnvioRestoDelMundo() {
        ProductoFisico prod = new ProductoFisico("Consola", 300.0, 0.0);
